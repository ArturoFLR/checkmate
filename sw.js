...
const j = "GET", x = (s) => s && typeof s == "object" ? s : { handle: s };
class R {
  /**
...
const J = (s) => new URL(String(s), location.href).href.replace(new RegExp(`^${location.origin}`), "");
class X {
  /**
...
let m;
const Y = () => (m || (m = new X(), m.addFetchListener(), m.addCacheListener()), m);
function T(s, e, t) {
  let n;
  if (typeof s == "string") {
...
}, E = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), ee = (s) => {
...
class I {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, r = new re(this, { event: t, request: n, params: a }), i = this._getResponse(r, n, t), c = this._awaitComplete(i, r, n, t);
    return [i, c];
  }
...
const H = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function pe(s) {
...
function we(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return V.set(n, e.sort ? e.sort() : [e]), f(n);
  } : fe().includes(s) ? function(...e) {
    return s.apply(L(this), e), f(H.get(this));
  } : function(...e) {
    return f(s.apply(L(this), e));
  };
}
function ye(s) {
  return typeof s == "function" ? we(s) : (s instanceof IDBTransaction && ge(s), ue(s, de()) ? new Proxy(s, N) : s);
}
function f(s) {
...
const be = ["get", "getKey", "getAll", "getAllKeys", "count"], Ce = ["put", "add", "delete", "clear"], U = /* @__PURE__ */ new Map();
function v(s, e) {
...
const xe = "workbox-expiration", w = "cache-entries", W = (s) => {
...
class Ee {
   ...
   */
  async getDb() {
    return this._db || (this._db = await _e(xe, 1, {
...
function Ue(s = {}) {
  ...
  T(({ url: r }) => r.origin === "https://fonts.googleapis.com", new ie({
    cacheName: e
  })), T(({ url: r }) => r.origin === "https://fonts.gstatic.com", new ce({
    cacheName: t,
    plugins: [
      new he({
        statuses: [0, 200]
...
class Ke {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = Te(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
function ve(s) {
  const e = $(), t = new Se(e, s);
  T(t);
}
const We = "-precache-", Be = async (s, e = We) => {
...
He();
je();
qe([{"revision":null,"url":"assets/index-4d7b823a.js"},{"revision":null,"url":"assets/index-fa416424.css"},{"revision":null,"url":"assets/workbox-window.prod.es5-a7b12eab.js"},{"revision":"5890e7bb9e932116ff944e05a334ce8d","url":"index.html"},{"revision":"d8c8838d0e55063f9b1670f91acc8128","url":"icons/pwa/manifest-icon-192.maskable.png"},{"revision":"b73c40049d9b787941b1f22af3de45dd","url":"icons/pwa/manifest-icon-512.maskable.png"},{"revision":"7a2f2a23ef97797f388b649985852fb0","url":"manifest.webmanifest"}]);
Ue();
